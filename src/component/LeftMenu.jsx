...
<div className="">
        <div className="flex flex-col border-b-[1px] border-[#dddddd] pb-1">
<div className="flex font-bold justify-between cursor-pointer pb-2 pt-2 items-center px-1 select-none"  onClick={()=>aboutLink() }>
        {about ? <h3 className="text-[14px] text-green hover:text-green ">About Yummly</h3> : <h3 className="text-[14px] hover:text-green ">About Yummly</h3>}
        {about ? <svg xmlns="http://www.w3.org/2000/svg" fill="#3a9691"  viewBox="0 0 320 512" className="w-2 font-semibold transition rotate-[90deg]"><path d="M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z"/></svg> :  <svg xmlns="http://www.w3.org/2000/svg" fill="#3a9691"  viewBox="0 0 320 512" className="w-2 font-semibold transition"><path d="M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z"/></svg>}
        </div>
{about ? 
<div className="flex flex-col gap-2 my-2 text-small cursor-pointer  px-1.5 transition">
{aboutUs ? <a className="text-green"  onClick={()=> aboutUsLink()}>About Us</a> : <a className="text-[#707070]"  onClick={()=> aboutUsLink()}>About Us</a>}
{careers ?  <a className="text-green"  onClick={()=> careersLink()}>Careers</a> : <a className="text-[#707070]"  onClick={()=> careersLink()}>Careers</a>}
{contact ? <a className="text-green"  onClick={()=> contactLink()}>Contact Us</a> : <a className="text-[#707070]"  onClick={()=> contactLink()}>Contact Us</a>}
{faq ?  <a className="text-green"  onClick={()=> faqLink()}>FAQs</a> : <a className="text-[#707070]"  onClick={()=> faqLink()}>FAQs</a>}
</div> : ""}
</div>
</div>

{about ?
<div className="flex flex-col gap-2.5 my-2 transition">
...
{about ?
<div className="flex w-full justify-between items-center gap-2.5 transition my-3">
...
<div className="transition">
    ...
    <a className="text-[11px] flex gap-1.5 mt-3 mb-2">port by <img src={whirle} /> </a>
</div> : ""}
